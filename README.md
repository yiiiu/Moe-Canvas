...
未经版权方单独书面授权，禁止将本项目或其衍生版本用于商业用途、SaaS、云服务、公开托管服务、收费服务、商业交付、外包交付、广告引流、会员订阅或其他直接/间接商业收益场景。

任何第三方公开部署、镜像站点、托管服务或改版服务均为非官方行为；请勿在非官方站点输入 API Key、授权码或其他敏感信息。
...
2. **克隆仓库**
   ...
   # 克隆项目
   git clone https://github.com/yiiiu/peak-canvas.git
   # 进入项目
   cd peak-canvas
   ```
3. **安装依赖并启动**
...
| **RunningHub**       | 图像生成，前往 [runninghub.com](https://www.runninghub.cn/) 获取 Key   |
| **APImart**          | 大语言模型,图像生成，前往 [APImart.ai](https://apimart.ai/zh/register) 获取 Key     |
| **派欧云 (PPIO)（准备下架）** | 大语言模型,图片生成，前往 [ppio.com](https://ppio.com/user/register) 获取 Key |
