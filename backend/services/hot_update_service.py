...
class HotUpdateService:
    ...
    def __init__(
        ...
        *,
        ...
        local_version,
        is_dev_build,
        update_manifest_url="https://github.com/yiiiu/peak-canvas/releases/latest/download/latest.json",
        update_release_url="https://github.com/yiiiu/peak-canvas/releases/latest",
