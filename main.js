const a117_0x6f57d = a117_0x58e5;
(function (_0x10f4b8, _0x3294a9) {
	const _0x576a29 = a117_0x58e5,
		_0x3ba5df = _0x10f4b8();
	while (!![]) {
		try {
			const _0xbdcd4c =
				(parseInt(_0x576a29(0x1a2)) / 0x1) *
					(parseInt(_0x576a29(0x18d)) / 0x2) +
				(-parseInt(_0x576a29(0x15d)) / 0x3) *
					(-parseInt(_0x576a29(0x16a)) / 0x4) +
				parseInt(_0x576a29(0x17e)) / 0x5 +
				parseInt(_0x576a29(0x170)) / 0x6 +
				parseInt(_0x576a29(0x171)) / 0x7 +
				(-parseInt(_0x576a29(0x180)) / 0x8) *
					(-parseInt(_0x576a29(0x18c)) / 0x9) +
				-parseInt(_0x576a29(0x18a)) / 0xa;
			if (_0xbdcd4c === _0x3294a9) break;
			else _0x3ba5df["push"](_0x3ba5df["shift"]());
		} catch (_0x5f70fb) {
			_0x3ba5df["push"](_0x3ba5df["shift"]());
		}
	}
})(a117_0xb199, 0x4e081);
import a117_0x6942c0, {
	graphStore,
	uiStore,
	workspaceStore,
...
import * as a117_0x3caf7d from "./src/modules/project.js";
...
import {
	getProjects as a117_0x47600d,
	createProject as a117_0x31f13a,
	deleteProject as a117_0x306d7e,
...
import a117_0x15002b from "./src/modules/ImageAnnotateController.js";
import a117_0x35c72a from "./src/modules/ImageMattingController.js";
import a117_0x23a946 from "./src/modules/AudioClipController.js";
...
import "./src/modules/assistantFabStateManager.js";
...
function publishRuntimeInfo(_0x2bc653 = {}) {
	const _0x3fea09 = a117_0x6f57d;
	((window[_0x3fea09(0x183)] = Boolean(_0x2bc653?.[_0x3fea09(0x1ab)])),
		(window[_0x3fea09(0x182)] = Boolean(_0x2bc653?.[_0x3fea09(0x19b)])),
		window["dispatchEvent"](
			new CustomEvent(_0x3fea09(0x19a), { detail: _0x2bc653 }),
		));
}
async function initLocalDevModeFromRuntime() {
	const _0x2d5797 = a117_0x6f57d;
	try {
		const _0xd0db0d = await fetchAppRuntimeInfoFromServer();
		(publishRuntimeInfo(_0xd0db0d),
			initDevEntries({
				isDevBuild: Boolean(_0xd0db0d?.[_0x2d5797(0x1ab)]),
			}));
	} catch (_0x167042) {
		(publishRuntimeInfo({ isDevBuild: ![], isAdvancedMode: ![] }),
...
for (const [type, ComponentClass] of Object[a117_0x6f57d(0x186)](
	NODE_COMPONENTS,
)) {
...
const wrap = document["getElementById"]("v2-wrap"),
	canvas = document[a117_0x6f57d(0x188)](a117_0x6f57d(0x175)),
	debug = document[a117_0x6f57d(0x188)](a117_0x6f57d(0x167));
(installRendererEventBindingGuard(),
	initRenderer(wrap, canvas, a117_0x6942c0),
	initRendererUiEvents({ wrap: wrap, store: a117_0x6942c0 }),
	initWebPreviewViewSyncService({ graphStore: graphStore, root: document }),
	initStoreRuntimeEffects(a117_0x6942c0),
	workspaceStore["setSubscriptionState"](createDefaultSubscriptionState()),
	(window[a117_0x6f57d(0x177)] = CanvasTabManager),
	document[a117_0x6f57d(0x188)]("btnAddCanvas")?.[a117_0x6f57d(0x1aa)](
		a117_0x6f57d(0x185),
	...
	initAppShellUi({
		...
		minimapEl: document[a117_0x6f57d(0x188)]("minimap"),
		btnMinimapEl: document[a117_0x6f57d(0x188)](a117_0x6f57d(0x193)),
		minimapWrapperEl: document[a117_0x6f57d(0x188)](a117_0x6f57d(0x164)),
		btnToggleDotsEl: document[a117_0x6f57d(0x188)](a117_0x6f57d(0x17b)),
		applySnapGridEnabled: applySnapGridEnabled,
		readSnapGridEnabled: readSnapGridEnabled,
		applyGridDotsPrefFromStorage: SettingsManager[a117_0x6f57d(0x16b)],
...
const appViewport = createAppViewport({
	...
	wrap: wrap,
	debugEl: debug,
	zoomSliderEl: document[a117_0x6f57d(0x188)](a117_0x6f57d(0x15f)),
	zoomPercentEl: document["getElementById"]("zoomPercent"),
	fitActionEl: document[a117_0x6f57d(0x188)]("btnFitAction"),
});
(appViewport["installWindowBindings"](window),
	import(a117_0x6f57d(0x1a7))["then"](({ assetManager: _0x433c20 }) => {}),
	import(a117_0x6f57d(0x17d))[a117_0x6f57d(0x19f)](
		({ workflowManager: _0x20fb9d }) => {},
	),
	import("./src/modules/GenerationHistoryFileManager.js")["then"](
		({ generationHistoryFileManager: _0x566521 }) => {},
	),
	initAppNodeEntry({
		graphStore: graphStore,
		wrap: wrap,
		btnAddEl: document[a117_0x6f57d(0x188)]("btnAdd"),
		nodeMenuEl: document[a117_0x6f57d(0x188)](a117_0x6f57d(0x1a5)),
...
function _v2GetDefaultNodeName(_0x159ef1) {
	const _0x4fad2c = a117_0x6f57d,
		_0x1e8c45 = String(_0x159ef1 || "");
	if (_0x1e8c45[_0x4fad2c(0x1a8)](_0x4fad2c(0x1a9))) return "图片";
	if (_0x1e8c45["includes"]("video")) return "视频";
	if (_0x1e8c45[_0x4fad2c(0x1a8)](_0x4fad2c(0x18b))) return "音频";
	if (_0x1e8c45[_0x4fad2c(0x1a8)](_0x4fad2c(0x18f))) return "文本";
	return "节点";
}
function _v2ApplySourceNameFromFileNameToNode(_0x19e1ce) {
	const _0x401ba4 = a117_0x6f57d;
	if (!_0x19e1ce || !_0x19e1ce["type"]) return _0x19e1ce;
	if (
		!String(_0x19e1ce[_0x401ba4(0x187)])[_0x401ba4(0x160)](_0x401ba4(0x18e))
	)
		return _0x19e1ce;
	const _0x35a37d = getBaseName(_0x19e1ce[_0x401ba4(0x174)]);
	if (!_0x35a37d) return _0x19e1ce;
	const _0x402e76 = _v2GetDefaultNodeName(_0x19e1ce[_0x401ba4(0x187)]);
	if (!_0x19e1ce["name"] || _0x19e1ce["name"] === _0x402e76)
		_0x19e1ce[_0x401ba4(0x189)] = _0x35a37d;
	return _0x19e1ce;
}
function _v2ApplySourceNamesFromFileNameToCanvas(_0x157a4a) {
	const _0x46448f = a117_0x6f57d;
	if (!_0x157a4a || !_0x157a4a[_0x46448f(0x173)]) return _0x157a4a;
	if (Array[_0x46448f(0x172)](_0x157a4a[_0x46448f(0x173)]))
		return (
			_0x157a4a[_0x46448f(0x173)][_0x46448f(0x165)](
				_v2ApplySourceNameFromFileNameToNode,
			),
			_0x157a4a
		);
	return (
		typeof _0x157a4a[_0x46448f(0x173)] === "object" &&
			Object[_0x46448f(0x195)](_0x157a4a["nodes"])["forEach"](
				_v2ApplySourceNameFromFileNameToNode,
			),
		_0x157a4a
	);
...
function _v2PatchStoreSourceNodeNamesFromFileName() {
	const _0x5220ee = a117_0x6f57d,
		_0xac72a7 = graphStore[_0x5220ee(0x16c)](),
		_0x1d52ed = _0xac72a7?.[_0x5220ee(0x173)] || {};
	Object["keys"](_0x1d52ed)[_0x5220ee(0x165)]((_0x4d98b3) => {
		const _0x195749 = _0x5220ee,
			_0x263e11 = _0x1d52ed[_0x4d98b3];
		if (
			!_0x263e11 ||
			!_0x263e11[_0x195749(0x187)] ||
			!String(_0x263e11[_0x195749(0x187)])[_0x195749(0x160)]("source-")
		)
			return;
		const _0x39b6e1 = getBaseName(_0x263e11["fileName"]);
		if (!_0x39b6e1) return;
		const _0x546e06 = _v2GetDefaultNodeName(_0x263e11[_0x195749(0x187)]);
		if (!_0x263e11[_0x195749(0x189)] || _0x263e11["name"] === _0x546e06)
			graphStore["renameNode"](_0x4d98b3, _0x39b6e1);
	});
}
(wrap[a117_0x6f57d(0x1aa)]("dragover", (_0x36c659) => {
	const _0x488a39 = a117_0x6f57d;
	_0x36c659[_0x488a39(0x161)]();
}),
	wrap[a117_0x6f57d(0x1aa)]("drop", async (_0x459266) => {
		const _0x4900da = a117_0x6f57d,
			_0x3ea209 = window[_0x4900da(0x19d)] || _0x4900da(0x178),
			_0x5b2a7b = await handleFileDrop(_0x459266, _0x3ea209);
		if (_0x5b2a7b) {
			commit();
			return;
		}
		const _0x2e281d = await handleWebImageUrlDrop(_0x459266, {
			projectId: _0x3ea209,
		});
		_0x2e281d && commit();
	}));
const appCanvasNodeFlows = createAppCanvasNodeFlows({
	graphStore: graphStore,
	commit: commit,
	getCursorScreenPosition: appCanvasPointerBindings[a117_0x6f57d(0x1a4)],
	getNodeDefaultSize: getNodeDefaultSize,
	...
	getCurrentProjectId: () => window[a117_0x6f57d(0x19d)],
	showToast: (..._0x1c0258) => window[a117_0x6f57d(0x196)]?.(..._0x1c0258),
});
function createBlobFromBase64(_0x1cc578, _0xa847ef = a117_0x6f57d(0x198)) {
	const _0x37bf31 = a117_0x6f57d,
		_0x6def5 = atob(String(_0x1cc578 || "")),
		_0x48e32d = [];
	for (
		let _0xa151b2 = 0x0;
		_0xa151b2 < _0x6def5["length"];
		_0xa151b2 += 0x2000
	) {
		const _0x244ad2 = _0x6def5[_0x37bf31(0x1a3)](
				_0xa151b2,
				_0xa151b2 + 0x2000,
			),
			_0x37e603 = new Uint8Array(_0x244ad2["length"]);
		for (
			let _0xfbdbb7 = 0x0;
			_0xfbdbb7 < _0x244ad2[_0x37bf31(0x16d)];
			_0xfbdbb7 += 0x1
		) {
			_0x37e603[_0xfbdbb7] = _0x244ad2[_0x37bf31(0x17a)](_0xfbdbb7);
		}
		_0x48e32d[_0x37bf31(0x19e)](_0x37e603);
	}
	return new Blob(_0x48e32d, { type: _0xa847ef });
}
function installGlobalScreenshotBridge() {
	const _0xe24ffc = a117_0x6f57d,
		_0xcca757 = window[_0xe24ffc(0x16e)]?.[_0xe24ffc(0x176)];
	(_0xcca757?.[_0xe24ffc(0x163)]?.(async (_0x42c183 = {}) => {
		const _0x396ad1 = _0xe24ffc;
		try {
			const _0x2f0a56 = String(_0x42c183?.[_0x396ad1(0x162)] || "")[
				"trim"
			]();
			if (!_0x2f0a56) return;
			const _0x284678 =
					String(_0x42c183?.[_0x396ad1(0x169)] || _0x396ad1(0x198)) ||
					_0x396ad1(0x198),
				_0x39f6e2 = createBlobFromBase64(_0x2f0a56, _0x284678),
				_0x34a636 = await appCanvasNodeFlows["createMediaNodeFromBlob"](
					_0x39f6e2,
					_0x284678,
					{
						name: _0x396ad1(0x197),
						placement: "viewport-center-sequence",
						sequenceKey: _0x396ad1(0x190),
					},
				);
			_0x34a636
				? window[_0x396ad1(0x196)]?.(
						"截图已添加到画布",
						_0x396ad1(0x17c),
					)
				: window["showToast"]?.(_0x396ad1(0x17f), "error");
		} catch (_0x4ac179) {
			(console[_0x396ad1(0x166)](_0x396ad1(0x181), _0x4ac179),
				window[_0x396ad1(0x196)]?.(_0x396ad1(0x17f), "error"));
		}
	}),
		_0xcca757?.[_0xe24ffc(0x1a1)]?.((_0x28f08c = {}) => {
			const _0x23cc31 = _0xe24ffc;
			if (
				_0x28f08c?.[_0x23cc31(0x199)] === ![] &&
				_0x28f08c?.[_0x23cc31(0x184)] === _0x23cc31(0x179)
			) {
				window["showToast"]?.(_0x23cc31(0x1a0), _0x23cc31(0x16f));
				return;
			}
			_0x28f08c?.[_0x23cc31(0x199)] === !![] &&
				_0x28f08c?.["ok"] === ![] &&
				window[_0x23cc31(0x196)]?.(
...
function a117_0xb199() {
	const _0x482c71 = [
		...
		"isAdvancedMode",
		"focusNodeAtZoomPercent",
		"currentProjectId",
		"push",
		"then",
		"全局\x20Alt+Q\x20注册失败，仍可在应用内使用\x20Alt+Q",
		"onGlobalShortcutStatus",
		"3188vhJQKe",
		"slice",
		...
		"btnToggleDots",
		"success",
		"./src/modules/workflows/WorkflowManager.js",
		"2214685HDBFex",
		"截图回填失败",
		"16736OzcmJr",
		"[screenshot]\x20failed\x20to\x20import\x20global\x20capture",
		"ADVANCED_MODE",
		"AI_CANVAS_IS_DEV_BUILD",
		"reason",
		"click",
	];
	a117_0xb199 = function () {
		return _0x482c71;
	};
	return a117_0xb199();
}
const appBusinessEvents = createAppBusinessEvents({
	...
	getNodeDefaultSize: getNodeDefaultSize,
	getAIGenerationDefaultSizeByType: getAIGenerationDefaultSizeByType,
	createNodeAtCursor: appCanvasNodeFlows[a117_0x6f57d(0x1a6)],
	createImageNodeFromBlob: appCanvasNodeFlows[a117_0x6f57d(0x191)],
	animateViewport: appViewport[a117_0x6f57d(0x15e)],
	focusNodeAtZoomPercent: appViewport[a117_0x6f57d(0x19c)],
	focusNodes: appViewport["focusNodes"],
	clearTrackedFocus: appViewport[a117_0x6f57d(0x194)],
	handlePasteFromClipboard: appCanvasNodeFlows["handlePasteFromClipboard"],
	initCanvasContextMenu: initCanvasContextMenu,
	ImageAnnotateController: a117_0x15002b,
	ImageMattingController: a117_0x35c72a,
	AudioClipController: a117_0x23a946,
});
appBusinessEvents[a117_0x6f57d(0x168)]();
...
function a117_0x58e5(_0x25d5ba, _0x3f3d87) {
	const _0xb199b9 = a117_0xb199();
	return (
		(a117_0x58e5 = function (_0x58e5e9, _0x3f3d3a) {
			_0x58e5e9 = _0x58e5e9 - 0x15d;
			let _0x948dcd = _0xb199b9[_0x58e5e9];
			return _0x948dcd;
		}),
		a117_0x58e5(_0x25d5ba, _0x3f3d87)
	);
}
appTopbarAndConfig[a117_0x6f57d(0x192)]();
...
(appPanels[a117_0x6f57d(0x192)](),
	CanvasProjectDropdownManager[a117_0x6f57d(0x192)](),
	SettingsManager[a117_0x6f57d(0x192)]({ uiStore: uiStore }),
	MascotManager[a117_0x6f57d(0x192)](),
	initAutoUpdate());
